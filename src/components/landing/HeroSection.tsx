  ...
  <div className="text-center mb-16 md:mb-24 animate-fade-in">
    ...
    <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center px-4 animate-fade-in" style={{ animationDelay: '600ms' }}>
      ...
      <Button
        ...
        size="lg"
        onClick={onDemo}
        className="border-2 border-white/20 bg-white/5 backdrop-blur-sm text-white hover:bg-white/10 hover:border-white/40 px-8 md:px-10 py-3 md:py-4 rounded-2xl text-base md:text-lg font-semibold transition-all duration-300 hover:scale-105 w-full sm:w-auto group"
      >
